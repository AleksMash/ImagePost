...
from common import get_file_extension, load_image
...
def main():
    load_dotenv()
    parser = argparse.ArgumentParser(description="Load images of the" " day from NASA API")
    parser.add_argument("-c", nargs="?", type=int, default=15, help="number of images (default=15)")
